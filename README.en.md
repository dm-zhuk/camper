# Rent-a-Camper: camper rentals project

## Pagination applied:

React component with pagination functionality using context. The key aspects:

- Create context with page logic
- Consume context in components
- Pass page handlers as props
- Centralize page state
